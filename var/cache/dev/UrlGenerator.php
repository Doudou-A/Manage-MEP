...
return [
    ...
    'project_create' => [[], ['_controller' => 'App\\Controller\\ProjectCreateController::index'], [], [['text', '/Project/Create']], [], []],
    ...
    'server_dashboard' => [['slug'], ['_controller' => 'App\\Controller\\ServerDashboardController::dashboard'], [], [['variable', '/', '[^/]++', 'slug'], ['text', '/Dashboard']], [], []],
    'add_subFolder_in_folder' => [['id', 'project'], ['project' => null, '_controller' => 'App\\Controller\\SubFolderAddController::addSubFolderInFolder'], [], [['variable', '/', '[^/]++', 'project'], ['text', '/Add/Sub-Folder'], ['variable', '/', '[^/]++', 'id']], [], []],
    ...
    'sub_folder_request' => [['id', 'project', 'server'], ['_controller' => 'App\\Controller\\SubFolderRequestController::subFolderRequest'], [], [['variable', '/', '[^/]++', 'server'], ['variable', '/', '[^/]++', 'project'], ['text', '/request'], ['variable', '/', '[^/]++', 'id'], ['text', '/Sub-Folder']], [], []],
];
