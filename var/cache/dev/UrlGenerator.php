...
return [
    ...
    'server_add_subFolder' => [['server'], ['_controller' => 'App\\Controller\\AddSubFolderController::addSubFolderInSubFolder'], [], [['variable', '/', '[^/]++', 'server'], ['text', '/server/add/sub_folder/subFolder']], [], []],
