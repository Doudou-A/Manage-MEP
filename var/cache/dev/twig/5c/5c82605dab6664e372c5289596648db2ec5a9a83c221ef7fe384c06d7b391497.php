...
class __TwigTemplate_ff41f8bb0f89bf77d75076fbffe9b1dab185f9e34346e23f1d732ddc19caacb9 extends Template
{
    private $source;
    private $macros = [];
...
\t";
        // line 9
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 9, $this->source); })()), "username", [], "any", false, false, false, 9), 'row', ["label" => "Nom d'utilisateur"]);
        echo "
\t\t";
        // line 10
...
\t\t";
        // line 11
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 11, $this->source); })()), "confirmPassword", [], "any", false, false, false, 11), 'row', ["label" => "Confirmation du mot de passe"]);
        echo "
...
";
    ...
    {
        return array (  118 => 21,  108 => 20,  95 => 16,  87 => 11,  83 => 10,  79 => 9,  75 => 8,  69 => 4,  59 => 3,  36 => 1,);
    }
...
\t\t{{ form_row(form.confirmPassword, { 'label': 'Confirmation du mot de passe'}) }}
\t\t<div class=\"row justify-content-center\">
\t\t\t<button type=\"submit\" class=\"btn btn-success my-3 font-MF\">Inscription !
\t\t\t</button>
\t\t</div>
...
\t</script>
{% endblock %}
", "security/registration.html.twig", "/Users/Adel/Documents/ARTEVA/Manage-MEP/templates/security/registration.html.twig");
    }
}
