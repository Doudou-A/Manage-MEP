...
\t\t<a href=\"javascript:visibilite('div_form";
            // line 5
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["subFolder"], "js_id", [], "any", false, false, false, 5), "html", null, true);
            echo "');\">
\t\t\t<p>Ajouter un Dossier</p>
\t\t</a>
\t\t<div id=\"div_form";
            // line 8
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["subFolder"], "js_id", [], "any", false, false, false, 8), "html", null, true);
...
\t<div class=\"testing\" id=\"";
            // line 37
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["subFolder"], "js_id", [], "any", false, false, false, 37), "html", null, true);
            echo "_request\"></div>
";
        }
...
\t\t</div>
\t</div>
\t<a id=\"{{subFolder.js_id}}\" class=\"btn js-test\">
\t\t<div id=\"{{subFolder.js_id}}_sign\">+</div>
\t</a>
\t<a id=\"{{subFolder.js_id}}\" class=\"btn js-test-moins\">
\t\t<div id=\"{{subFolder.js_id}}_sign-\"></div>
\t</a>
\t<div class=\"testing\" id=\"{{subFolder.js_id}}_request\"></div>
{% endfor %}
